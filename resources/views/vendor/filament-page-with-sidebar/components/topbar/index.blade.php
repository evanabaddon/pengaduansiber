...
<div class="mt-8">
    <nav class="flex items-center gap-x-2  px-4 py-2 rounded-md dark:bg-gray-900 dark:ring-white/10 md:px-4 lg:px-4 overflow-x-scroll">
        @if ($sidebar->getTitle() != null || $sidebar->getDescription() != null)
            <div class="me-6 hidden lg:flex flex-col">
                <h3 class="text-base font-medium text-gray-400  dark:text-white truncate block">
                    {{ $sidebar->getTitle() }}
                </h3>
