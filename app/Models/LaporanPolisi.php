...
class LaporanPolisi extends Model
{
    ...
    {
        return $this->hasOne(LaporanPolisiAnalysis::class, 'laporan_id');
    }

    protected static function booted()
    {
        static::deleting(function ($laporanPolisi) {
            $laporanPolisi->korbans()->delete(); // Hapus semua korban terkait
            $laporanPolisi->pelapors()->delete(); // Hapus semua pelapor terkait
            $laporanPolisi->terlapors()->delete(); // Hapus semua terlapor terkait
        });
    }
