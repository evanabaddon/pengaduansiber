...
use App\Filament\Widgets\BackToAdminWidget;
...
class BagbinopsnalPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->discoverPages(in: app_path('Filament/Bagbinopsnal/Pages'), for: 'App\\Filament\\Bagbinopsnal\\Pages')
            ->pages([
                Dashboard::class,
                EditProfile::class,
            ])
            ...
            ->discoverWidgets(in: app_path('Filament/Bagbinopsnal/Widgets'), for: 'App\\Filament\\Bagbinopsnal\\Widgets')
            ->widgets([
