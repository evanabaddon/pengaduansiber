...
namespace App\Filament\Bagbinopsnal\Resources\LaporanInfoResource\Pages;
...
use App\Filament\Bagbinopsnal\Resources\LaporanInfoResource;
...
class CreateLaporanInfo extends CreateRecord
{
    ...
    public function handleRecordCreation(array $data): LaporanInfo
    {
        // Implementasi handleRecordCreation
        try {
            // Simpan data utama
            $data['status'] = 'Proses';
            ...
            $laporanInfo = LaporanInfo::create($data);
            ...
            if (isset($data['pelapors'])) {
                ...
                $pelapor = Pelapor::create([
                    'laporan_info_id' => $laporanInfo->id,
                    ...$pelaporData
                ]);
            ...
            if (isset($data['terlapors'])) {
                $data['terlapors']['nama'] = $data['terlapors']['nama'] ?: 'Belum ada nama terlapor';
            ...
            if (isset($data['barangBuktis'])) {
                $laporanInfo->barangBuktis()->createMany($data['barangBuktis']);
            }
