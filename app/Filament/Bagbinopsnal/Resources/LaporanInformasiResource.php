...
use App\Filament\Bagbinopsnal\Resources\LaporanInformasiResource\Pages;
                    ...
                    ->steps([
                        Wizard\Step::make('Pelapor')
                            ...
                            ->afterValidation(function ($state, $component) {
                                ...
                                if ($component->getLivewire() instanceof Pages\CreateLaporanInformasi) {
                        ...
                        Wizard\Step::make('Terlapor')
                            ...
                            ->afterValidation(function ($state, $component) {
                                // cek apakah sedang di halaman create
                                if (request()->routeIs('filament.resources.laporan-informasis.create')) {
            ...
            ->actions([
                ActionGroup::make([
                    Action::make('Analyze')
                        ...
                        ->action(function (LaporanInformasi $record, OllamaService $ollamaService, DeepSeekService $deepSeekService) {
                            try {
