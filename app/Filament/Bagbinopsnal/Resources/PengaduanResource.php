...
use App\Filament\Bagbinopsnal\Resources\PengaduanResource\Pages;
use Parfaitementweb\FilamentCountryField\Forms\Components\Country;
use App\Filament\Bagbinopsnal\Resources\PengaduanResource\RelationManagers;
use App\Filament\Bagbinopsnal\Resources\PengaduanResource\Pages\EditPengaduan;
use App\Filament\Bagbinopsnal\Resources\PengaduanResource\Pages\ListPengaduans;
use App\Filament\Bagbinopsnal\Resources\PengaduanResource\Pages\CreatePengaduan;
...
class PengaduanResource extends Resource
{
    ...
    {
        // Mendapatkan ID panel saat ini
        // $panelId = Filament::getCurrentPanel()->getId();

        // dd($panelId);
        

        // if ($panelId === 'bagwassidik') {
        //     return [
        //         'index' => Pages\ListPengaduans::route('/'),
        //         'view' => Pages\ViewPengaduan::route('/{record}'), // Menambahkan halaman 'view'
        //     ];
        // }
